...
class Vehicle {
  ...
  async vin(){
    return await this.service.request('get', 'vin');
  }

  async charge(){
    return await this.service.request('get', 'charge');
  }

  async battery(){
    return await this.service.request('get', 'battery');
  }

  async batteryCapacity(){
    return await this.service.request('get', 'battery/capacity');
  }

  async fuel(){
    return await this.service.request('get', 'fuel');
  }

  async tirePressure(){
    return await this.service.request('get', 'tires/pressure');
  }

  async engineOil(){
    return await this.service.request('get', 'engine/oil');
  }

  async odometer(){
    return await this.service.request('get', 'odometer');
  }

  async location(){
    return await this.service.request('get', 'location');
  }

  async attributes(){
    return await this.service.request('get', '/');
  }

  async permissions(){
    return await this.service.request('get', 'permissions');
  }

  async lock(){
    return await this.service.request('post', 'security', {
      action: 'LOCK',
    });
  }
  ...
  async startCharge(){
    return await this.service.request('post', 'charge', {
      action: 'START',
    });
  }
  ...
  async disconnect(){
    return await this.service.request('delete', 'application');
  }
   ...
   *   for all possible errors.
   */
  async unsubscribe(amt, webhookId) {
